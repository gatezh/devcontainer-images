...
**Steps:**
- [x] Update ralphex-bun references to ralphex-fe in documentation links section
- [x] Update usage examples with new image name
- [x] Update repository structure examples if applicable
